...
python train.py --dataset-type dynerf --exp-name dynerf-colmap --data-dir ./data/dynerf --dataset cut_roasted_beef
python render.py --exp-name dynerf-colmap --data-dir ./data/dynerf --dataset cut_roasted_beef